...
# Load the config
config_path = "configs/samuel_remodel_configs/filtered_config_s2_nn.yaml"
model_name = None
...
# load best performing epoch!
ckpt_path = glob.glob(dir_save_checkpoints + 'epoch=*-step=*.ckpt')[0]
